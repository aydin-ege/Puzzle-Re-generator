"""
This code connects to NYTimes website
and parses all the information neccessary.
Finally, it saves it all into a file caled
aiFood.
"""
...
for e in re.findall("(>[A-Z1-9]<)", str(soup.findAll("text"))):
    while 1:
        if puzzle[counter] == '#':
            counter += 1
            continue
